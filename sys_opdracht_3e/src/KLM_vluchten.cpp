 ...
 * @author  Rob Beaufort
 * @brief   Dit is opdracht 3e van systeemarchitectuur. Hier wordt er geoefend met classes. 
 *          Deze classes maken onderdeel uit van een vliegtuigmaatschappij. 
 *          De vlucht klas kan aangepmaakt worden met behulp van een array van piloten, crewleden en passagiers 
 *          daarnaast moet er ook een bestemming  en een vliegtuig worden ingevoerd.
 *          Hierbij kunnen er ook al vluchten worden aangemaakt.
 * @version 1.0
 * @date    29-4-2025
 */
#include <iostream>
